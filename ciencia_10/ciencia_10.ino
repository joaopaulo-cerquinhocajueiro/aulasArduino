...
// pins
#define SPEAKER   12   // Piezo Speaker pin (positive, other pin to ground)
...
void chirp2() {  // Bird chirp
  for(uint8_t i=300; i>270; i--)
     playTone(i,9);
}

void chirp3() {  // Bird chirp
...
void scale() {
  for(uint16_t i=50; i<15000; i+=10)  {
     playTone(i,20);
  }
}
